...
@Observable class CardObject: ObservableObject {
    
    var cards: [CardModel] = [
        CardModel(id: 0, name: "Dandelion", element: Element.Air, gender: Gender.Masculine, planet: Planet.Jupiter, powers: ["Wishes", "Spirit-Calling"], image: "Dandelion", rarity: .Common ),
        CardModel(id: 1, name: "Mandrake", element: .Fire, gender: .Masculine, planet: .Mercury, powers: ["Money", ""], image: "Mandrake", rarity: .Common),
        CardModel(id: 2, name: "Milk Thistle", element: .Fire, gender: .Masculine, planet: .Mars, powers: ["Hex-Break", "Protection", "Healing"], image: "Milk Thistle", rarity: .Common),
        ...
        CardModel(id: 4, name: "Plantain", element: .Earth, gender: .Feminine, planet: .Venus, powers: ["Protection", "Strength"], image: "Plantain", rarity: .Common),
        ...
        CardModel(id: 6, name: "Black Mustard", element: .Fire, gender: .Masculine, planet: .Mars, powers: ["Fertility", "Mental Powers"], image: "Black Mustard", rarity: .Rare),
        ...
        CardModel(id: 9, name: "Mugwort", element: .Earth, gender: .Feminine, planet: .Venus, powers: ["Psychic Abilities", "Dreams"], image: "Mugwort", rarity: .Common),
