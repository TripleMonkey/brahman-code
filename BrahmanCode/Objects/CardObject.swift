...
@Observable class CardObject: ObservableObject {
    ...
    var cards: [CardModel] = [
        ...
        CardModel(id: 6, name: "Black Mustard", element: .Fire, gender: .Masculine, planet: .Mars, powers: ["Fertility", "Mental Powers"], image: "Black Mustard", rarity: .Rare, isLocked: true),
        ...
        CardModel(id: 9, name: "Mugwort", element: .Earth, gender: .Feminine, planet: .Venus, powers: ["Psychic Abilities", "Dreams"], image: "Mugwort", rarity: .Common, isLocked: false),
