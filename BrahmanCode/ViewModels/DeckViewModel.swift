...
class DeckViewModel: ObservableObject {
    ...
    private init() { 
        cards = [
               ...
               CardModel(id: 3, name: "Pokeweed", element: .Fire, gender: .Masculine, planet: .Mars, powers: ["Courage", "Hex-Break"], image: "Pokeweed", rarity: .Rare, isLocked: true),
               ...
               CardModel(id: 5, name: "Wild Onion", element: .Fire, gender: .Masculine, planet: .Mars, powers: ["Money", "Healing"], image: "Wild Onion", rarity: .Common, isLocked: true),
               ...
               CardModel(id: 17, name: "Stinging Nettle", element: .Fire, gender: .Masculine, planet: .Mars, powers: ["Protection", "Strength"], image: "Stinging Nettle", rarity: .Common, isLocked: true),
        ...
        currentCard = CardModel(id: 0, name: "Dandelion", element: Element.Air, gender: Gender.Masculine, planet: Planet.Jupiter, powers: ["Wishes", "Spirit-Calling"], image: "Dandelion", rarity: .Common, isLocked: true )
    }
